  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `lecturas_fc` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `bpm` INTEGER NOT NULL, `estado` TEXT NOT NULL, `dispositivo` TEXT NOT NULL, `hora` TEXT NOT NULL, `sincronizado` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '42059f02ebb518fd18aef431fd2c31dc')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsLecturasFc = new HashMap<String, TableInfo.Column>(6);
        ...
        if (!_infoLecturasFc.equals(_existingLecturasFc)) {
          return new RoomOpenHelper.ValidationResult(false, "lecturas_fc(mx.utng.cfga.smarthealthmonitor.data.db.LecturaFC).\n"
                  + " Expected:\n" + _infoLecturasFc + "\n"
                  + " Found:\n" + _existingLecturasFc);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "42059f02ebb518fd18aef431fd2c31dc", "11375b0caf7af7e8ef1f634696275aa7");
